...
class ScheduleInput(BaseModel):
    ...
    algorithm: str = Field(default="ga", description="ga | hill_climbing | sa | minimax")
    persist_schedule: bool = Field(default=True, description="False: không lưu Schedule vào DB (dùng cho so sánh/benchmark)")
